        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServingSizeGrams = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NutritionData", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NutritionData_FoodItems_FoodItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetProteinGrams = table.Column<double>(type: "float", nullable: false),
                    TargetCarbsGrams = table.Column<double>(type: "float", nullable: false),
                    TargetFatsGrams = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivityLvl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    InsertedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValueSql: "GETDATE()")
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NutritionDatas_FoodItemId",
                table: "NutritionData",
                column: "FoodItemId",
                unique: true);
